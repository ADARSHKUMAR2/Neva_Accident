...
public class RCC_AICarController : MonoBehaviour {
	...
	void Awake() {
		...
		//navigatorObject.GetComponent<UnityEngine.AI.NavMeshAgent>().avoidancePriority = 10000;
	...
	void Navigation (){
        ...
        //if(navigator.SetDestination(waypointsContainer.waypoints[5].position))
        //{
